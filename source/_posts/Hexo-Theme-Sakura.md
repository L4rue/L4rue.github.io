...
author: hojun
avatar: https://cdn.jsdelivr.net/gh/L4rue/PicGoCDN@master/img/custom/avatar.jpg
authorLink: hojun.cn
authorAbout: 一个好奇的人
authorDesc: 一个好奇的人
categories: 技术
...
[paypal](https://www.paypal.me/hojuncn) | [Alipay 支付宝](https://cdn.jsdelivr.net/gh/L4rue/PicGoCDN@master/img/custom/donate/AliPayQR.jpg) | [WeChat Pay 微信支付](https://cdn.jsdelivr.net/gh/L4rue/PicGoCDN@master/img/custom/donate/WeChanSQ.jpg)
...
# 站点cdn，没有就为空 【改】  若是cdn为空，一些图片地址就要填完整地址了，比如之前avatar就要填https://cdn.jsdelivr.net/gh/L4rue/PicGoCDN@master/img/custom/avatar.jpg
cdn: https://cdn.jsdelivr.net/gh/L4rue/PicGoCDN@master
...
# 懒加载的加载中图片 【选】
lazyloadImg: https://cdn.jsdelivr.net/gh/L4rue/PicGoCDN@master/img/loader/orange.progress-bar-stripe-loader.svg
...
技术:
    ...
    # 封面图片
    img: https://cdn.jsdelivr.net/gh/L4rue/PicGoCDN@master/img/banner/coding.jpg
生活:
    zh: 生活
    en: live
    img: https://cdn.jsdelivr.net/gh/L4rue/PicGoCDN@master/img/banner/writing.jpg

#tag
# 标签名即是标题
悦读:
    # 封面图片
    img: https://cdn.jsdelivr.net/gh/L4rue/PicGoCDN@master/img/banner/reading.jpg
```
